...
/**
 * Created by liubin on 2017/5/29.
 */
...
public class RecordProvider extends ContentProvider {
    ...
    static {
        ...
        // of the pets table.
        sUriMatcher.addURI(RecordContract.CONTENT_AUTHORITY, RecordContract.PATH_PETS, RECORDS);
        ...
        sUriMatcher.addURI(RecordContract.CONTENT_AUTHORITY, RecordContract.PATH_PETS + "/#", RECORD_ID);
    }
...
//        String name = values.getAsString(RecordEntry.COLUMN_RECORDING_NAME);
//        if (name == null) {
//            throw new IllegalArgumentException("Pet requires a name");
//        }
//
//        // Check that the gender is valid
//        Integer gender = values.getAsInteger(RecordEntry.COLUMN_PET_GENDER);
//        if (gender == null || !RecordEntry.isValidGender(gender)) {
//            throw new IllegalArgumentException("Pet requires valid gender");
//        }
//
//        // If the weight is provided, check that it's greater than or equal to 0 kg
//        Integer weight = values.getAsInteger(RecordEntry.COLUMN_PET_WEIGHT);
